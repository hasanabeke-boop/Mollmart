    ...
    items: [
      {
        ...
        text: "Время поиска поставщика сократили на 70%. Одна заявка — 12 офферов за сутки.",
      },
      {
        name: "Марк Т.",
        role: "Продавец handmade",
        text: "Раньше угадывал спрос. Теперь вижу заявки и отвечаю напрямую — продажи выросли вдвое.",
      },
      {
        name: "Елена Р.",
        role: "Малый бизнес",
        text: "Два режима в одном аккаунте — утром закупки, днём продажи. Без лишнего трения.",
      },
    ],
  },
  faq: {
...
const kk: LandingCopy = {
  ...
  testimonials: {
    ...
    items: [
      {
        name: "Сара К.",
        role: "Сатып алу менеджері",
        text: "Жеткізуші іздеу уақыты 70%-ға қысқарды. Бір сұрау — тәулікте 12 ұсыныс.",
      },
      {
        name: "Марк Т.",
        role: "Handmade сатушы",
        text: "Бұрын сұранысты болжайтын едім. Енді нақты сұрауларға жауап беремін.",
      },
      {
        name: "Елена Р.",
        role: "Шағын бизнес",
        text: "Таңертең сатып алушы, күндіз сатушы — бір платформа.",
      },
    ],
  },
  faq: {
